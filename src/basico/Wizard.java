...
public class Wizard extends Application {
	...
	private void criarPasso1() {
		...
		proximoPasso.setOnAction(e -> {janela.setScene(passo2);janela.setTitle("Wizard :: Passo 02");});
		...
		passo1 = new Scene(box, 300, 300);
	}
	
	private void criarPasso2() {
		Button proximoAnterior = new Button("Voltar p/ Passo 1>>");
		proximoAnterior.setOnAction(e -> {janela.setScene(passo1);janela.setTitle("Wizard :: Passo 01");});
		
		Button proximoPasso = new Button("Ir p/ Passo 3>>");
		proximoPasso.setOnAction(e -> {janela.setScene(passo3);janela.setTitle("Wizard :: Passo 03");});
		...
		passo2 = new Scene(box, 300, 300);
	}
	
	private void criarPasso3() {
		Button proximoAnterior = new Button("Voltar p/ Passo 2>>");
		proximoAnterior.setOnAction(e -> {janela.setScene(passo2);});
